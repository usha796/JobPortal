...
foreach($results as $result)
{
 ...
 <img src="images/<?php echo $row->ProfilePic;?>" width="100" height="100" >
     ...
     <div class="text-box">
                  ...
                  <div class="btn-row"> 
                    <!-- <a href="Jobseekersresumes/<?php echo htmlentities($result->Resume);?>" class="resume" target="_blank"><i class="fa fa-file-text-o"></i>Resume</a> -->
                   <a href="profile.php" class="login">Edit Profile</a> <a href="add-education.php" class="login">Add Education</a><a href="add-experience.php" class="login">Add Experience</a></div>
