...
<input type="text" placeholder="you@jobsalerts.com"></div>
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <input type="text" placeholder="e.g. “Waiter,Manger”">
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="selector">
                ...
                <select class="full-width">
                  ...
                  <option value="2">Janakpur</option>
                  <option value="3">Hetauda</option>
                  <option value="4">Pokhara</option>
                  <option value="4">Birendranagar</option>
                  <option value="4">Dipayal Silgadhi</option>
