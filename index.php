...
<meta charset="utf-8">
<title> Online Job Portal || Home Page</title>
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-5 col-sm-5">
                ...
                <input type="text" placeholder="Enter Hotel/Trekking agency name" name="company">
...
<?php if (strlen($_SESSION['jsid']==0)) {?>
        <div class="btn-row"> <a href="sign-up.php"><i class="fa fa-user"></i>Jobseeker?</a> <a href="employers/emp-login.php"><i class="fa fa-building-o"></i> Employer?</a> </div>
<?php } ?>
      </div>
